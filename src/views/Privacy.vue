<template lang="pug">
    Page(scrollable)
        ...
        ol(type="I")
            li Information about us as controllers of your data
            li The rights of users and data subjects
            li Information about the data processing
        ...
        p
            | Simao Gomes Viana
            br
            | E-Mail: simaogmv at gmail dot com
        ...
        p Likewise, under Art. 21 GDPR, users and data subjects have the right to object to the controller's future processing of their data pursuant to Art. 6 Para. 1 lit. f) GDPR. In particular, an objection to data processing for the purpose of direct advertising is permissible.
        ...
        p.small-text Model Data Protection Statement for Anwaltskanzlei Weiß & Partner
</template>
